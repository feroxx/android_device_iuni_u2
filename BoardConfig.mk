...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.selinux=permissive androidboot.hardware=qcom user_debug=31 maxcpus=4 androidboot.bootdevice=msm_sdcc.1
